...
/*----------------------------------------------------------------------*/
  ...
  function header_options() {
    if ($(".right-menu").length) {
      $(
        '<div class="plus" data-cursor-type="medium"><span data-cursor-type="medium"></span><span data-cursor-type="medium"></span></div>'
      ).insertAfter('.right-menu nav ul li.hassub a:not("ul li ul li a")');
